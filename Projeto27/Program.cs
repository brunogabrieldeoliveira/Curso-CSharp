    ...
    internal class Program
    {
        ...
        public static void CadastraUsuario(ref List<DadosCadastraisStruct> ListaDeUsuarios)
        {
            ...
            if (PegaString(ref cadastroUsuarios.Nome, "Digite o nome completo ou S para sair") != Resultado_e.Sucesso)
                return;
            if (PegaData(ref cadastroUsuarios.DataDeNascimento, "Digite a data de nascimento no formato DD/MM/AAAA ou S para sair") != Resultado_e.Sucesso)
                return;
            if (PegaString(ref cadastroUsuarios.NomeDaRua, "Digite o nome da rua ou S para sair") != Resultado_e.Sucesso)
                return;
            if (PegaUInt32(ref cadastroUsuarios.NumeroDaCasa, "Digite o numero da casa ou S para sair") != Resultado_e.Sucesso)
                return;
