    ...
    internal class InterfaceGrafica
    {
        ...
        public Resultado_e CadastraUsuario()
        {
            ...
            if (PegaData(ref DataDeNascimento, "Digite a data de nascimento no formato DD/MM/AAAA ou S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            if (PegaString(ref NumeroDoDocumento, "Digite o número do seu documento ou S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            if (PegaString(ref NomeDaRua, "Digite o nome da rua ou S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            if (PegaUInt32(ref NumeroDaCasa, "Digite o numero da casa ou S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
        ...
        {
            Console.Clear();
            Console.WriteLine("Digite o numero do documento para busca o usuário ou digite S para sair");
            string temp = Console.ReadLine();
            if (temp.ToLower() == "s")
                return;
        ...
        {
            Console.Clear();
            Console.WriteLine("Digite o numero do documento para remover o usuário ou digite S para sair");
            string temp = Console.ReadLine();
            if (temp.ToLower() == "s")
                return;
